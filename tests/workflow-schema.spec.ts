...
test.describe("workflow helpers", () => {
  ...
  test("event lifecycle actions expose close, archive, restore, and delete workflows", () => {
    ...
    expect(eventCrud).toContain("bulkCloseEventsAction");
    expect(eventCrud).toContain("bulkDeleteEventsAction");
    ...
    expect(eventCrud).toContain("One or more selected events has contact history and cannot be deleted");
