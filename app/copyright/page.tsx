      ...
      <section className="mx-auto max-w-3xl">
        <Card>
          <CardHeader>
            ...
            <CardDescription>ShepardRoute product, workflow, and content notice.</CardDescription>
          </CardHeader>
          <CardContent className="space-y-5 text-sm leading-6 text-slate-700">
            <p>Copyright (c) {year} ShepardRoute. All rights reserved unless a separate written license says otherwise.</p>
            <p>
              The ShepardRoute name, product workflows, interface text, event template wording, routing logic, reports, and documentation are provided for church follow-up operations.
